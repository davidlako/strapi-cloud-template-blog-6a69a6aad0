...
export interface ApiMicroLearningMicroLearning
  extends Struct.CollectionTypeSchema {
  collectionName: 'micro_learnings';
  info: {
    displayName: 'MicroLearning';
    pluralName: 'micro-learnings';
    singularName: 'micro-learning';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiSdfsdfSdfsdf extends Struct.CollectionTypeSchema {
  collectionName: 'sdfsdfs';
  info: {
    displayName: 'sdfsdf';
    pluralName: 'sdfsdfs';
    singularName: 'sdfsdf';
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    sdf: Schema.Attribute.Component<'shared.appointment-cta', true>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::sdfsdf.sdfsdf': ApiSdfsdfSdfsdf;
